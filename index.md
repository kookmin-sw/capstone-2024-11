...
<body>
    ...
    <div align="center">
        ...
        <h2>프로젝트 구현 개요</h2>
        <ol>
            <h4>cv2와 dlib을 사용하여 이미지속 사람의 얼굴을 인식합니다.</h4>
            <h4>인식된 얼굴의 81개의 랜드마크 좌표를 활용하여 얼굴의 비율을 구합니다.</h4>
            <h4>인식된 얼굴에서 피부 부분만을 추출합니다.</h4>
            <h4>추출한 정보를 벡터화하여 학습데이터를 구축합니다.</h4>
        </ol>
        <br>
        ...
        <h3>팀장</h3>
        <ul>
            <h4><a href="https://github.com/Topadonijah">****1668 정태성</a></h4>
            <p>Role: 얼굴형 검출 및 헤어스타일 추천 모델 구현</p>
        </ul>
        <h3>팀원</h3>
        <ul>
            <h4><a href="https://github.com/lkl4502">****1627 오홍석</a></h4>
            <p>Role: 백엔드 개발, 퍼스널컬러 진단 구현</p>
            <h4><a href="https://github.com/Jeon3625">****1659 전기정</a><h4>
            <p>Role: 퍼스널컬러 모델 구현</p>
            <h4><a href="https://github.com/wjsquddn">****1660 전병우</a></h4>
